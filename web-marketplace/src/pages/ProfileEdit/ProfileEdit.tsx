...
import { BRIDGE, PORTFOLIO } from './ProfileEdit.constants';
  ...
  return (
    <div className="bg-grey-100">
      <div className="relative md:flex md:min-h-screen">
        ...
        {/* Content area - add blur when mobile menu is open */}
        <div
          className={cn(
            'flex-1 min-w-0 w-full md:w-auto pt-[60px] md:pt-0 transition-all duration-300',
