...
const PostFilesCardsMobile = ({
  ...
  return (
    <div className="sm:hidden pl-[7px] pt-[362px]">
      <Slider {...settings} className={styles.mobileSlider} ref={slider}>
        {files.map(file => {
          ...
          return (
            ...
            >
              <Box
                className="rounded-t-[10px] h-[183px]"
                sx={theme => ({
                  position: 'relative',
              ...
              <div className="h-40 bg-grey-0"></div>
              <div
                onClick={onClose}
