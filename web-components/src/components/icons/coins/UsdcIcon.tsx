...
export default function UsdcIcon({
  ...
  return (
    ...
    >
      ...
      <path
        className="st1"
        d="M104 217c0 3-2.4 4.7-5.2 3.8C60 208.4 32 172.2 32 129.3c0-42.8 28-79.1 66.8-91.5 2.9-.9 5.2.8 5.2 3.8v7.5c0 2-1.5 4.3-3.4 5C69.9 65.4 48 94.9 48 129.3c0 34.5 21.9 63.9 52.6 75.1 1.9.7 3.4 3 3.4 5v7.6z"
      />
      <path
        className="st1"
      ...
      <path
        className="st1"
        d="M157.2 220.8c-2.9.9-5.2-.8-5.2-3.8v-7.5c0-2.2 1.3-4.3 3.4-5 30.6-11.2 52.6-40.7 52.6-75.1 0-34.5-21.9-63.9-52.6-75.1-1.9-.7-3.4-3-3.4-5v-7.5c0-3 2.4-4.7 5.2-3.8C196 50.2 224 86.5 224 129.3c0 42.9-28 79.1-66.8 91.5z"
      />
    </SvgIcon>
  );
}
