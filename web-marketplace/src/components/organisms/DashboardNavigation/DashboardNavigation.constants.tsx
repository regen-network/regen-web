...
export const COLLAPSE_BUTTON_CLASSES =
  'group hidden md:flex items-center justify-center w-[25px] h-[25px] absolute z-10 right-[-12.5px] top-[35px] p-0 rounded-[5px] border border-solid border-grey-300 bg-[#FFFFFF] shadow-[0_0_8px_rgba(0,0,0,0.15)] cursor-pointer hover:bg-bc-green-600 hover:text-bc-neutral-100';
...
export const LIST_BASE_CLASSES =
  'group flex items-center border-none transition-colors rounded-md pl-[10px] max-h-[40px]';
