...
export const PersonalProfileModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-bc-neutral-100 rounded-lg relative flex flex-col border-solid border-[1px] border-bc-neutral-300 px-20 py-40 md:p-40 w-[360px] md:w-[560px] h-[90%] max-h-[1000px]">
        <button
          onClick={onClose}
          aria-label="close"
        ...
        <H variant="h4" className="mb-10 mx-auto">
        ...
        <div className="mt-40 flex justify-end gap-40 pt-20">
          <button
            onClick={onClose}
