...
export const errors = {
  ...
  invalid_user_password:
    'This email and password combination is not correct, please try again',
  mfa_invalid_code:
  ...
  PasswordHistoryError:
    'The password provided for sign up/update has already been used',
...
export function isAuth0Error(e: unknown): e is Auth0Error {
  return (e as Auth0Error).error !== undefined;
}
