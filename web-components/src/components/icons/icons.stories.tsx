...
import { PortfolioNoEcocredits } from './PortfolioNoEcocredits';
...
export const allIcons = (): JSX.Element => (
  <Grid container gap={4}>
    ...
    <LabeledIcon icon={<ImageIcon />} label="ImageIcon" />
    ...
    <LabeledIcon icon={<NoCreditClassesIcon />} label="NoCreditClassesIcon" />
    ...
    <LabeledIcon icon={<VideoIcon />} label="VideoIcon" />
