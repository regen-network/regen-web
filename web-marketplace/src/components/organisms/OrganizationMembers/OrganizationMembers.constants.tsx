...
export const REGEN_ADDRESS_REQUIRED_ERROR =
  'Enter a REGEN address in order to add this user as an Owner, Admin or Editor.';
export const INVALID_EMAIL_OR_REGEN_ADDRESS_ERROR = 'Invalid email or REGEN address';
