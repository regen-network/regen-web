      ...
      <div className="relative border-solid border-[1px] border-bc-neutral-300 rounded-lg overflow-hidden">
        ...
        <div className="relative z-10 p-20 pb-30 flex flex-col">
          ...
          <div className="flex flex-col justify-end xl:max-w-[70%]">
            <Title
              variant="h3"
              className="text-bc-neutral-0 mb-2 line-clamp-2 mb-20 text-ellipsis [overflow-wrap:anywhere] [text-shadow:0_0_20px_rgba(0,0,0,0.25)]"
            >
              {projectName}
            </Title>

            {/* Address + area */}
            <div className="mb-20 max-h-[40px] max-w-[251px] md:max-w-[596px] text-ellipsis [overflow-wrap:anywhere] [text-shadow:0_0_20px_rgba(0,0,0,0.25)]">
              <ProjectPlaceInfo
