...
export const SIGNED_IN_AS = msg`signed in as`;
export const CREATE_ORG = msg`create new organization`;
export const FINISH_ORG_CREATION = msg`finish creating organization`;
export const PERSONAL_PROFILE = msg`Personal profile`;
export const ORGANIZATION_PROFILE = msg`Organization profile`;
