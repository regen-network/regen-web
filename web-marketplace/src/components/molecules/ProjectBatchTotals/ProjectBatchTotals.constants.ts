...
export const TRADEABLE_CREDITS_TOOLTIP = msg`Tradable credits have no yet been retired and can be held, sold, or sent to another party. Includes escrowed credits.`;
