...
export const CHOOSE_CREDIT_CLASS_LINK = msg`Learn more about creating a credit class»`;
...
export const CREATE_OFFCHAIN_PROJECT_TITLE = msg`Create a project without a credit class`;
export const CREATE_OFFCHAIN_PROJECT_DESCRIPTION = msg`You will not be able to issue credits with this option unless you later register this project with a credit class.`;
export const CREATE_OFFCHAIN_PROJECT_LINK = msg`Learn more»`;
