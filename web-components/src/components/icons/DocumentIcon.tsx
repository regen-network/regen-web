  ...
  return (
    <SvgIcon viewBox="0 0 18 22" className={className} {...props}>
      <svg width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="4" y="11" width="1" height="10" rx="0.25" transform="rotate(-90 4 11)" fill={main} />
        <rect x="4" y="14" width="1" height="10" rx="0.25" transform="rotate(-90 4 14)" fill={main} />
        <rect x="4" y="17" width="1" height="8" rx="0.25" transform="rotate(-90 4 17)" fill={main} />
        <path d="M11.6432 6.49983L11.6432 1.07539L16.9998 6.5L11.6432 6.49983Z" fill={shade} />
        <path d="M11.5 1V6.25C11.5 6.38807 11.6119 6.5 11.75 6.5H17.5" stroke={accent} />
        <path d="M1 21V1H9H12.0601L17 6.38898V21H1Z" stroke={main} strokeWidth="2" />
      </svg>
    </SvgIcon>
  );
};
