...
export const NAV_BASE_CLASSES =
  'relative flex flex-col h-screen overflow-visible transition-all duration-300 border-0 border-r border-solid border-r-[#D2D5D9] bg-bc-neutral-0 max-h-screen';
