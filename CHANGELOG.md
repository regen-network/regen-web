...
- dao rbam alpha2 version ([#2808](https://github.com/regen-network/regen-web/issues/2808)) ([65bdd85](https://github.com/regen-network/regen-web/commit/65bdd85d6d0beca6edf374325ec00bd660a1e494))
- NEXT_PUBLIC_PRE_PROPOSE_SINGLE_CODE_ID ([eb477f2](https://github.com/regen-network/regen-web/commit/eb477f205b25ad9874ad8dceb5fb7875b14962d1))
- org enabled ui ([bbfa952](https://github.com/regen-network/regen-web/commit/bbfa952fa5cb0398f0db77bbc158e9ef2797bb15))
- rm role_id ([acba64b](https://github.com/regen-network/regen-web/commit/acba64bf98139630fe148f3b29f62131be998c26))
...
- APP-755 handle invalid Stripe amount errors from backend ([#2715](https://github.com/regen-network/regen-web/issues/2715)) ([21d91e8](https://github.com/regen-network/regen-web/commit/21d91e8eeaf86d6f18f8f70e898a03777bf220e9))
- APP-759 success modal missing after creating a sell order from sell dashboard ([#2774](https://github.com/regen-network/regen-web/issues/2774)) ([02c8e05](https://github.com/regen-network/regen-web/commit/02c8e05abfe2be6f63111cf4fb6008dfaf17aea0))
- APP-771 Minimal front-end updates to support organization database migrations ([#2728](https://github.com/regen-network/regen-web/issues/2728)) ([09b6fcc](https://github.com/regen-network/regen-web/commit/09b6fcc15057f4fc01f1773f9ebc7f4eeec27cb7))
- APP-822 hide org dashboard controls from user dashboard when user type is org ([#2780](https://github.com/regen-network/regen-web/issues/2780)) ([f1da510](https://github.com/regen-network/regen-web/commit/f1da510433af966b4d3c6bcf22e97c4da106b325))
- APP-823 incorrect amount of credits ([#2766](https://github.com/regen-network/regen-web/issues/2766)) ([1826e54](https://github.com/regen-network/regen-web/commit/1826e54b9b1373790b8750e331e04a6482730986))
- APP-824 show insufficient balance on org creation ([#2770](https://github.com/regen-network/regen-web/issues/2770)) ([e9b7328](https://github.com/regen-network/regen-web/commit/e9b732850869f39ca81f7b20c3bf055f60ec571e))
...
- APP-826 error on credit batch page ([#2771](https://github.com/regen-network/regen-web/issues/2771)) ([41050a7](https://github.com/regen-network/regen-web/commit/41050a728e036b23cadcc8d1d557589635f1be92))
- APP-827 weird line in credit batch table ([#2776](https://github.com/regen-network/regen-web/issues/2776)) ([40182b5](https://github.com/regen-network/regen-web/commit/40182b58efe6034f1c223d7f1730d169ecce9ecb))
- APP-833 fix wallet connect ([#2779](https://github.com/regen-network/regen-web/issues/2779)) ([389eaff](https://github.com/regen-network/regen-web/commit/389eaffc7ab6ab9a5ccebcee5a2cfa1410e92dee))
- APP-834 hide "issued credit batches" on web2 user dashboard ([#2778](https://github.com/regen-network/regen-web/issues/2778)) ([f4bb1b7](https://github.com/regen-network/regen-web/commit/f4bb1b7a1acf824b572ee81f738d73ca6ddd7962))
- APP-839 nav bug when going to project edit ([#2783](https://github.com/regen-network/regen-web/issues/2783)) ([4126bbe](https://github.com/regen-network/regen-web/commit/4126bbee2262eba59b58ed47e97c48c74b339d07))
...
- APP-870 portfolio on org dashboard for web2 user ([#2794](https://github.com/regen-network/regen-web/issues/2794)) ([5233d1e](https://github.com/regen-network/regen-web/commit/5233d1ef9445f20d0d119a52f10be2906148a479))
- APP-871 overlay and text shadow in project dashboard banner ([#2798](https://github.com/regen-network/regen-web/issues/2798)) ([b4ca9ad](https://github.com/regen-network/regen-web/commit/b4ca9ad73f629bfd900d3aa031539b954d9f1c75))
- APP-872 migrating project from collaborators tab ([#2797](https://github.com/regen-network/regen-web/issues/2797)) ([dc6152f](https://github.com/regen-network/regen-web/commit/dc6152f5bb022880461bec9fbfb49841c58f5c1c))
- APP-877 project page without header ([#2796](https://github.com/regen-network/regen-web/issues/2796)) ([fd5819b](https://github.com/regen-network/regen-web/commit/fd5819b8edafd6ca578d75555e820a606f72d735))
- create org from dashboard with web2 user ([#2782](https://github.com/regen-network/regen-web/issues/2782)) ([a7299db](https://github.com/regen-network/regen-web/commit/a7299db1fdc5220a7d4dc9455c53bee1f5bd2e79))
...
- REGEN_WORKER_ADDRESS env ([fa1f4b4](https://github.com/regen-network/regen-web/commit/fa1f4b41dacc926c01dbba363867ef91d21da3d1))
- revert back to amino signing ([3ba09ac](https://github.com/regen-network/regen-web/commit/3ba09acae8e15faee119f3c2eece58bbf49c17a8))
- set resolveDenom to false in getAllBalancesQuery ([bf5b6a0](https://github.com/regen-network/regen-web/commit/bf5b6a0f0d5adb73442b62516634416eb1ce6b36))
- use sign mode direct ([debcd44](https://github.com/regen-network/regen-web/commit/debcd44529945fd8f7813381a126ddd08e45f01d))
...
- APP-732 create org invite members ([#2722](https://github.com/regen-network/regen-web/issues/2722)) ([f3c5f47](https://github.com/regen-network/regen-web/commit/f3c5f47450b6723d313ca4dbec76f22559e71239))
- APP-740 Handle seller dashboard edge cases with Wallet Connect ([#2731](https://github.com/regen-network/regen-web/issues/2731)) ([0629a63](https://github.com/regen-network/regen-web/commit/0629a63dd350dc3b95d25d605fcafcd84e644452))
- APP-743 update hero section rendering to conditionally display icon image ([#2721](https://github.com/regen-network/regen-web/issues/2721)) ([8245e6d](https://github.com/regen-network/regen-web/commit/8245e6d434e73721be72cf23d735a5c8940fc31f))
...
- APP-763 Incorrectly showing credit classes on dashboard only if issuer ([#2726](https://github.com/regen-network/regen-web/issues/2726)) ([29782e6](https://github.com/regen-network/regen-web/commit/29782e6b95d9af01e34ee96055775e94eb460705))
- APP-766 change sell to sell orders in dashboard left nav ([#2734](https://github.com/regen-network/regen-web/issues/2734)) ([e28b79f](https://github.com/regen-network/regen-web/commit/e28b79f804e11b84dd36f2718f6b4bf118c76f93))
- APP-772 follow up comments for 674 ([#2720](https://github.com/regen-network/regen-web/issues/2720)) ([70acca6](https://github.com/regen-network/regen-web/commit/70acca6a5bc2af445cbc27dc8acf51be569a8b87))
...
- APP-777 create organization 2 migrate projects (part 2) ([#2746](https://github.com/regen-network/regen-web/issues/2746)) ([5532404](https://github.com/regen-network/regen-web/commit/55324044505271cb13c2d48bbbfba11f17b4647b))
...
- APP-794 organization members ([#2767](https://github.com/regen-network/regen-web/issues/2767)) ([775ab6b](https://github.com/regen-network/regen-web/commit/775ab6b32a75bada2dc6fb3db9df8f48c3f89a30))
...
- APP-816 project page multi user admin ([#2763](https://github.com/regen-network/regen-web/issues/2763)) ([78ba76d](https://github.com/regen-network/regen-web/commit/78ba76db757d85d24309f722022c3cae240df65a))
- APP-818 empty user profile if transferred to org ([#2758](https://github.com/regen-network/regen-web/issues/2758)) ([f1793dc](https://github.com/regen-network/regen-web/commit/f1793dca79083fdb99637cef790dcf50a4021075))
- APP-819 update organization profile step to handle default image values ([#2754](https://github.com/regen-network/regen-web/issues/2754)) ([0d51c0b](https://github.com/regen-network/regen-web/commit/0d51c0b77f22d262c5a3c61fc0da95f5323ac066))
- APP-821 stripe account set up from org dashboard ([#2775](https://github.com/regen-network/regen-web/issues/2775)) ([0fd68ae](https://github.com/regen-network/regen-web/commit/0fd68ae01fb8baffbca8d3ba93b768c3401fd5f1))
- APP-831 add create org to dashboard dropdown ([#2773](https://github.com/regen-network/regen-web/issues/2773)) ([5f5ad24](https://github.com/regen-network/regen-web/commit/5f5ad243f12cc76d79fe0b5df3ec7b7057a1cffb))
- APP-836 ledger v7 upgrade ([#2772](https://github.com/regen-network/regen-web/issues/2772)) ([9409c37](https://github.com/regen-network/regen-web/commit/9409c370ff1da44a62c27e243667cdad60ca6c12))
- APP-849 underline in user menu ([#2785](https://github.com/regen-network/regen-web/issues/2785)) ([b5bc53d](https://github.com/regen-network/regen-web/commit/b5bc53d27730b6cdc4f2f53009af8785dbde9bd8))
- APP-852 data events indexed ([#2791](https://github.com/regen-network/regen-web/issues/2791)) ([8532d3d](https://github.com/regen-network/regen-web/commit/8532d3ddaf7017ecfdda7519dcd67a7a9fa2c0c8))
- APP-854 add select field for org/user for signing data post ([#2790](https://github.com/regen-network/regen-web/issues/2790)) ([68d8db0](https://github.com/regen-network/regen-web/commit/68d8db068dc3fa17b5fee07b4818ce76e38d59c5))
- APP-857 loading fix ([#2787](https://github.com/regen-network/regen-web/issues/2787)) ([c64fea4](https://github.com/regen-network/regen-web/commit/c64fea43701ee5284394ae919deca1784f9d1ab4))
- APP-866 stay on same page when switching dashboards ([#2789](https://github.com/regen-network/regen-web/issues/2789)) ([e164987](https://github.com/regen-network/regen-web/commit/e16498762eb6bb2e871f0e0eca80afe123b2823c))
